...
options <- list(
    ...
    make_option("--flank",    type="integer",    default=0,    help="Number of flanking bases to consider [default %default]", metavar="number"),
    ...
    #make_option("--ignoretype",    type="logical",   default=TRUE,    help="if TRUE, ignore SV types [default %default]", metavar="logical")
)
...
hits <- findOverlaps(sample, sampleunique, minoverlap=1, maxgap=arguments$flank)
